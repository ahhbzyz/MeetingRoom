...
public class RoomStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(TimeUtils.getCurrentDateAndWeek(getApplicationContext()));
       ...
       // GetRoomEventList getUserEvents = new GetRoomEventList(roomEventRepository);
        ...
        ctv.setOnCircleBtnClickListener(new CircleTimerView.OnBtnClickListener() {
            @Override
        ...
        ctv.setOnCountDownListener(new CircleTimerView.OnCountDownListener() {
            @Override
