    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                float cx = mIndicatorLeft + (mIndicatorRight -  mIndicatorLeft) / 2f;
                float cy = getHeight() - (mSelectedIndicatorHeight * 2);
                canvas.drawCircle(cx, cy, 8f, mSelectedIndicatorPaint);
            }
        }
    }
